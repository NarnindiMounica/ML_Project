...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        ''' This function is responsible for data transformation of columns based on column type'''
        try:
            ...
            cat_pipeline=Pipeline(steps=[('imputer', SimpleImputer(strategy='most_frequent')), ('one_hot encoder', OneHotEncoder()), ('scaler', StandardScaler(with_mean=False))])
